  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col text-white [background:radial-gradient(ellipse_at_70%_30%,#0ea5e9_0%,#0369a1_50%,#0c1a2e_100%)] [font-family:'Segoe_UI',system-ui,sans-serif]">
        <ClerkProvider>
          <div className="min-h-screen flex items-center justify-center [background:radial-gradient(ellipse_at_70%_30%,#0ea5e9_0%,#0369a1_50%,#0c1a2e_100%)] [font-family:'Segoe_UI',system-ui,sans-serif]">
            {children}
          </div>
        </ClerkProvider>
      </body>
